...
gulp.task('default', ['watch','js-libs','ng-libs','app-common-min-js','app-components-js','app-common-js','app-common-html','app-components-html','app-components-styles','css-libs','imagemin']);
...
gulp.task('watch', function() {
    ...
    gulp.watch('src/assets/**/*', ['imagemin','css-libs']);
});